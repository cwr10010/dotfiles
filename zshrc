...
export ZSH=/Users/carsten/.oh-my-zsh
...
export PATH="~/.local/bin:/usr/local/bin:/usr/texbin:~/Applications:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/MacGPG2/bin:/usr/texbin"
